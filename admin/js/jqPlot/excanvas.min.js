    ...
    (function() {
        ...
        q.stroke = function(al) {
            ...
            for (var ah = 0; ah < this.currentPath_.length; ah++) {
                ...
                if (j) { if (ag.x == null || j.x < ag.x) { ag.x = j.x } if (ak.x == null || j.x > ak.x) { ak.x = j.x } if (ag.y == null || j.y < ag.y) { ag.y = j.y } if (ak.y == null || j.y > ak.y) { ak.y = j.y } }
            }
            aj.push(' ">');
            if (!al) { w(this, aj) } else { G(this, aj, ag, ak) }
