 ...
 */
(function(e) {
    e.jqplot.DonutRenderer = function() { e.jqplot.LineRenderer.call(this) };
    ...
    e.jqplot.DonutRenderer.prototype.setGridData = function(s) {
        ...
        for (var q = 0; q < this.data.length; q++) {
            if (this.data[q][1] != 0) { this._drawData = true }
    ...
    e.jqplot.DonutRenderer.prototype.drawSlice = function(x, u, t, p, s) {
        ...
        function o() {
            if (t > 6.282 + this.startAngle) { t = 6.282 + this.startAngle; if (u > t) { u = 6.281 + this.startAngle } }
            if (u >= t) { return }
            x.beginPath();
            x.fillStyle = p;
            x.strokeStyle = p;
        ...
        if (s) { for (var q = 0; q < this.shadowDepth; q++) { x.restore() } }
        x.restore()
    };
    e.jqplot.DonutRenderer.prototype.draw = function(N, V, t, P) {
        ...
        for (var Q = 0; Q < this._previousSeries.length; Q++) { T -= 2 * this._previousSeries[Q]._thickness + 2 * X }
        ...
        } else { this._thickness = this.thickness || v / 2 / (this._numberSeries + 1) * 0.85 }
    ...
    e.jqplot.DonutAxisRenderer = function() { e.jqplot.LinearAxisRenderer.call(this) };
    ...
    e.jqplot.DonutLegendRenderer = function() { e.jqplot.TableLegendRenderer.call(this) };
    ...
    e.jqplot.DonutLegendRenderer.prototype.draw = function() {
        ...
        if (this.show) {
            ...
            if (z.show) {
                var G = z.data;
                if (this.numberRows) { n = this.numberRows; if (!this.numberColumns) { v = Math.ceil(G.length / n) } else { v = this.numberColumns } } else {
                ...
                var A = 0;
                for (E = 0; E < n; E++) {
                    if (x) { p = e('<tr class="jqplot-table-legend"></tr>').prependTo(this._elem) } else { p = e('<tr class="jqplot-table-legend"></tr>').appendTo(this._elem) }
                    for (D = 0; D < v; D++) {
                        if (A < G.length) {
                            u = this.labels[A] || G[A][0].toString();
                            C = o.next();
                            if (!x) { if (E > 0) { F = true } else { F = false } } else { if (E == n - 1) { F = false } else { F = true } }
                            ...
                            if (this.escapeHtml) { r.text(u) } else { r.php(u) }
                            if (x) {
                                r.prependTo(p);
                                t.prependTo(p)
                            } else {
    ...
    function c(r, q, o) {
        ...
        var n = false;
        if (o.seriesDefaults.renderer == e.jqplot.DonutRenderer) { n = true } else { if (o.series) { for (var p = 0; p < o.series.length; p++) { if (o.series[p].renderer == e.jqplot.DonutRenderer) { n = true } } } }
        if (n) {
    ...
    function g(r, q, o) {
        for (var p = 1; p < this.series.length; p++) { if (!this.series[p]._previousSeries.length) { for (var n = 0; n < p; n++) { if (this.series[p].renderer.constructor == e.jqplot.DonutRenderer && this.series[n].renderer.constructor == e.jqplot.DonutRenderer) { this.series[p]._previousSeries.push(this.series[n]) } } } }
        for (p = 0; p < this.series.length; p++) { if (this.series[p].renderer.constructor == e.jqplot.DonutRenderer) { this.series[p]._numberSeries = this.series.length; if (this.series[p].highlightMouseOver) { this.series[p].highlightMouseDown = false } } }
    ...
    function j(p, o, s, r, q) { var n = q.plugins.donutRenderer.highlightedSeriesIndex; if (n != null && q.series[n].highlightMouseDown) { i(q) } }
    ...
    function m(r, q, u, t, s) {
        if (t) {
            ...
            if (n != null && s.series[n].highlightMouseDown) { i(s) }
    ...
    e.jqplot.DonutTickRenderer = function() { e.jqplot.AxisTickRenderer.call(this) };
