    ...
    $.fn.prettyPhoto = function(pp_settings) {
     ...
     <div class="pp_overlay"></div>', gallery_markup: '<div class="pp_gallery"> \
        ...
        $.prettyPhoto.open = function(event) {
            ...
            if (pp_descriptions[set_position] != "") { $pp_pic_holder.find('.pp_description').show().php(unescape(pp_descriptions[set_position])); } else { $pp_pic_holder.find('.pp_description').hide(); }
