    ...
    d.extend(M.prototype, {
        ...
        _attachments: function(a, b) {
            ...
            if (c == "button" || c == "both") {
                ...
                b.trigger = d(this._get(b, "buttonImageOnly") ? d("<img/>").addClass(this._triggerClass).attr({ src: f, alt: c, title: c }) : d('<button type="button"></button>').addClass(this._triggerClass).php(f == "" ? c : d("<img/>").attr({ src: f, alt: c, title: c })));
